...
/**
 * This will fetch the usr from the Auth_header per given request object.
 * @param {Request}This a req from Express request object.
...
/**
 * This will fetch the usr from the X-Token_header per given request object.
 * @param {Request}This will req from Express request object.
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
